...
UPDATE 2026-05-24
Unifi now supports my use case. I don't know which version of the network application supports it but I'm currently on 10.3.58 and was able to configure it.

Frontier: WAN1
Starlink: WAN2
WAN mode: Failover only
WAN2 IPv6 configuration: SLAAC, prefix delegation, 56 bits
"Policy Engine"/"Objects": Add a "Route" - type: IP Address - subnet: 2000::/3 (for some reason it doesn't like 0::/0) - interface: WAN2 - make sure to associate it with one or more clients
