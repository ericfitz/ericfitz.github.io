...
The code generated was correct on the first try and I haven’t had to fix any bugs in it.
...
➤
Log. A lot. With a lot of detail. Create ways to capture state and
make it visible while the program is running so you can give it to the
agent. Build logging in at the beginning, and keep reminding the agent
to use it.

## If you’re building a UI, you can also give log-like visibility in your UI.

![](/images/llm-coding-agents-part-2-1.png)
...
![](/images/llm-coding-agents-part-2-2.png)
...
## That's it!I hope that these tips help you become more effective at creating software with AI agents!
