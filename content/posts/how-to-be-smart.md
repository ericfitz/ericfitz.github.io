...
I started thinking of this post when I read a recent article "[Read to Forget](https://mo42.bearblog.dev/read-to-forget/)", on Hacker News.  It's very short and I highly recommend it.  HN discussion [here](https://news.ycombinator.com/item?id=45239601).
...
In researching this post, I also found [this article](https://archive.ph/AXvXU#selection-687.160-702.0), which has been removed from Medium (use a bookmark manager!) but shares a similar sentiment.

---

I have been blessed in my professional life to work with people that are as smart or smarter than me.  I listen to them and watch what they do and try to figure out what I can learn from them to improve myself.
...
A lot of people aren't honest with themselves, or just never consider whether they are telling themselves what they want to hear/believe, rather than what actually is.
...
You might have noticed a theme about how I came to these realizations - I spend a lot of time thinking, and in particular I expose my own ideas to the same rigorous level of challenge I would apply to anyone else' ideas, and I try to do it before my ideas get exposed to others if I can.  But the important thing is that I:
...
I debated with myself about whether to throw this one in here, because it's controversial.  However I think it's controversial more because of how I phrase it than what I mean:
...
Anyway, that's enough for today's bit of wisdom; I hope it helps you or at least entertained you for a few minutes.
